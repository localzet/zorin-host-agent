...
if($LASTEXITCODE-ne0) {
    throw 'TPM identity migration failed.'
}
Write-Host '';
Write-Host 'IMPORTANT: the phone will see a NEW host cryptographic identity.' -ForegroundColor Yellow;
Write-Host 'Run 2-PAIR-OWNER.bat and approve the new fingerprint on the phone.' -ForegroundColor Yellow
